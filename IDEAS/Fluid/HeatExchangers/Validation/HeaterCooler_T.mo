...
model HeaterCooler_T
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaHigPowOut(redeclare package
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort cooLimPowOut(redeclare package
      Medium = Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort heaCooUnlOut(redeclare package
      Medium = Medium, m_flow_nominal=m_flow_nominal) "Temperature sensor"
