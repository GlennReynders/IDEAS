...
equation
  if approximateWetBulb then
    ...
    TWetBul = (TDryBul *
                ...
                (Xi[iWat]-XiSat) * IDEAS.Utilities.Psychrometrics.Constants.h_fg)/
            ( (1-XiSat)*IDEAS.Utilities.Psychrometrics.Constants.cpAir +
            XiSat * IDEAS.Utilities.Psychrometrics.Constants.cpSte);
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
