...
experiment(
      ...
      StopTime=1.5,
      Tolerance=1e-08),
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/InverseXDerivative_2_Check.mos"
        "Simulate and plot"),
...
IDEAS.Utilities.Math.Functions.BaseClasses.der_2_smoothTransition</a>.
