...
partial model PartialSimInfoManager_Twinhouse
  ...
  parameter Modelica.SIunits.Angle lon(displayUnit="deg") = 0.204588;
...
protected
  ...
  TwinHouseGeert.ReaderTwinhouse            weaDat(filNam=filNamClim, lat=lat, lon=lon, timZon=timZonSta) if useTmy3Reader
...
end PartialSimInfoManager_Twinhouse;
